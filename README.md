![AMRAdapterLiftoff: Admost Mediation iOS SDK](https://www.admost.com/img/logo.svg)
...
[![CocoaPods Compatible](https://img.shields.io/cocoapods/v/AMRAdapterLiftoff.svg?style=flat-square)](https://img.shields.io/cocoapods/v/AMRAdapterLiftoff.svg)
...
Liftoff (Vungle) adapter for AMRSDK. Allows publishers to mediate Liftoff banner, interstitial and video ads in AMRSDK.
...
```
https://github.com/admost/AMR-IOS-ADAPTER-LIFTOFF.git
```

> **Important:** Add `-ObjC` to **Other Linker Flags** in your app target's Build Settings.
